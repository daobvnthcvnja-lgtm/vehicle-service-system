...
class MainShellMixin:
    ...
    def load_staff_customers(self):
        ...
        table_border = tk.Frame(self.view_frame, bg="#D0DDD9", padx=1, pady=1)
        table_border.pack(fill="both", expand=True)
        table_frame = tk.Frame(table_border, bg=ui_helpers.COLOR_WHITE)
        ...
        self.customer_tree.column("HoTen", width=250, anchor="center")
        self.customer_tree.column("SoDienThoai", width=180, anchor="center")
        self.customer_tree.column("DiaChi", width=350, anchor="center")
        
        # Alternating row tags
        self.customer_tree.tag_configure("evenrow", background="#FFFFFF")
        self.customer_tree.tag_configure("oddrow",  background="#F0F5F3")
    ...
    def refresh_customer_table(self, query=""):
        ...
        for idx, r in enumerate(rows):
            ...
            self.customer_tree.insert("", "end", values=r, tags=(tag,))
    ...
    def load_staff_slips(self):
        ...
        self.slip_table = ui_helpers.ScrollableTable(
            ...
            col_widths=[70, 155, 190, 85, 165, 130, 120],
            col_anchors=["center", "center", "center", "center", "center", "center", "center"]
        )
    ...
    def open_create_slip_dialog(self, slip_data=None):
        ...
        def add_service_to_list(sv_data):
            if any(s[0] == sv_data[0] for s in selected_services):
                ...
                return
            selected_services.append((sv_data[0], sv_data[3], sv_data[4], sv_data[2]))
            render_selected_services()
    ...
    def load_staff_payments(self):
        ...
        self.invoice_tree.column("TenPhieu", width=150, anchor="center")
        self.invoice_tree.column("KhachHang", width=220, anchor="center")
        self.invoice_tree.column("TongTien", width=120, anchor="center")
        ...
        self.invoice_tree.tag_configure("oddrow",  background="#F0F5F3")
    ...
    def load_manager_dashboard(self):
        ...
        if dist:
            ...
            ax1.legend(wedges, wrapped_labels, title="Danh mục", loc="center left", bbox_to_anchor=(0.95, 0.5), fontsize=8, labelspacing=1.2)
            fig1.subplots_adjust(left=0.05, right=0.60, top=0.85, bottom=0.05)
        else:
    ...
    def load_manager_services(self):
        ...
        self.services_table = ui_helpers.ScrollableTable(
            ...
            col_widths=[200, 340, 170, 200],
            col_anchors=["center", "center", "center", "center"]
        )
    ...
    def open_add_service_dialog(self):
        ...
        def save():
            ...
            try:
                db.add_service(cat_id, sv_name, 0, self.current_user["id"])
    ...
    def load_manager_staff(self):
        ...
        self.staff_table = ui_helpers.ScrollableTable(
            ...
            col_widths=[60, 230, 170, 160, 110, 180],
    ...
    def load_manager_invoices(self):
        ...
        self.m_invoice_table = ui_helpers.ScrollableTable(
            ...
            col_widths=[60, 155, 240, 115, 110, 130, 100],
            col_anchors=["center", "center", "center", "center", "center", "center", "center"]
        )
    ...
    def load_manager_customer_care(self):
        ...
        self.care_table = ui_helpers.ScrollableTable(
            ...
            col_widths=[140, 155, 110, 230, 140, 140],
            col_anchors=["center", "center", "center", "center", "center", "center"]
        )
        ...
        def refresh_care_table():
            ...
            for s in slips:
                ...
                if len(sv_summary) > 55:
                    sv_summary = sv_summary[:52] + "..."
